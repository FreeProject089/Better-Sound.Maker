...
export function renderFaq(container) {
  const faqs = [
    ...
    },
    {
      q: t('faq.q5.title'),
      a: t('faq.q5.desc'),
      extra: `<a href="https://github.com/FreeProject089/Better-ModMaker" target="_blank" class="btn btn-secondary btn-sm" style="margin-top: 12px; display: inline-flex;">${getIcon('github', 'w-4 h-4')} ${t('creditsPage.github.title')}</a>`
    },
    {
      q: t('faq.q6.title'),
      a: t('faq.q6.desc'),
