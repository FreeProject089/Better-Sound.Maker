# Patch Notes v1.0.4 - Better Sound.maker
...
- **Local License**: The license is now loaded directly from the local installation folder when running as an Electron app.
- **Code Optimization**: Improved the asset analysis pipeline and state management for smoother performance.
- **Naming Consistency**: Unified the app name to "Better Sound.maker" across all documentation.
